class Vecteur3D():
    ...
    def save(self,nom='vec.dat'):
        '''Sauvegarde le vecteur dans un fichier binaire'''
    ...
    def load(self,nom='vec.dat'):
        '''Charge le vecteur depuis un fichier binaire'''
...
if __name__ == "__main__": # false lors d'un import
    ...
    print(v1,vL,v3)
    # affiche: Vecteur3D(6.12323e-17, 1, 0) Vecteur3D(6.12323e-17, 1, 0) Vecteur3D(0, 0, 1)