...
def run():
    ...
    masse1 = Particule(masse=2,pos=v3d(0.6, 0.5),name='masse1',color='red',fix=False, rayon=10)
    masse2 = Particule(masse=2,pos=v3d(0.7, 0.5),name='masse2',color='green',fix=False, rayon=10)
