...
def run():
    ...
    Monde = Univers(name = 'sys6',step=0.001, W=10000, H=700)
    ...
    mur1 = Particule(pos=v3d(0.1, 0.),name='mur1',color='black',fix=True)
    mur2 = Particule(pos=v3d(0.9, 0.),name='mur2',color='black',fix=True)
    # Particule(masse, pos, vit, name, color, fix)

    masse1 = Particule(pos=v3d(0.3, 0.01),name='masse1',color='red',fix=False)
    masse2 = Particule(pos=v3d(0.4, 0.01),name='masse2',color='red',fix=False)
